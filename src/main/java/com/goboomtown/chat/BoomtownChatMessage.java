...
import com.goboomtown.chat.JSONHelper;
...
//            this.id = java.util.UUID.randomUUID().toString();
        ...
        this.from = tokens[0];
//        this.fromName = getParticipantInfo(this.from, "name");
//        this.fromMention = getParticipantInfo(this.from, "alias");
//        if ( this.fromName == null )
//            this.fromName = this.from;
//        if ( this.fromMention == null )
//            this.fromMention = this.from;
    ...
    public void populateFromString(String message)
    {
        ...
        try {
            ...
            if ( this.dateString == null ) {
                ...
                sdf.setTimeZone(TimeZone.getTimeZone("UTC"));
//            if ( message.hasExtension("delay", "urn:xmpp:delay") ) {
//                message.getExtension("delay", "urn:xmpp:delay");
//            }
//            else
                this.date = new Date();
                this.dateString = sdf.format(this.date);
