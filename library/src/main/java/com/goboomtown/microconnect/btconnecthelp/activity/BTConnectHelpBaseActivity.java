...
public abstract class BTConnectHelpBaseActivity extends AppCompatActivity {

    public final static String TAG = BTConnectHelpBaseActivity.class.getSimpleName();
    ...
    public Map<String, BoomtownChatMessage.Emoticon> chatEmoticons;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setChatEmoticons(buildEmoticonsIndexFromAssets(BoomtownChatMessage.ASSET_PATH_EMOTICONS));
    }
...
//                            BoomtownAPI.sharedInstance().isLocationPermitted = grantResults[i] == PackageManager.PERMISSION_GRANTED;
//                            break;
//                        case Manifest.permission.CAMERA:
//                            BoomtownAPI.sharedInstance().isCameraPermitted = grantResults[i] == PackageManager.PERMISSION_GRANTED;
//                            break;
//                        case Manifest.permission.CAPTURE_VIDEO_OUTPUT:
//                            BoomtownAPI.sharedInstance().isVideoCapturePermitted = grantResults[i] == PackageManager.PERMISSION_GRANTED;
//                            break;
//                        case Manifest.permission.RECORD_AUDIO:
//                            BoomtownAPI.sharedInstance().isAudioCapturePermitted = grantResults[i] == PackageManager.PERMISSION_GRANTED;
//                            break;
//                        case Manifest.permission.WRITE_EXTERNAL_STORAGE:
//                            BoomtownAPI.sharedInstance().isExtStorageWriteable = grantResults[i] == PackageManager.PERMISSION_GRANTED;
//                            break;
//                        default:
//                            Log.w(TAG, "unknown permissions value received: " + permissions[i]);
//                            break;
//                    }
//                }
//                break;
//            case 1:
//                // If request is cancelled, the result arrays are empty.
//                BoomtownAPI.sharedInstance().isLocationPermitted = grantResults.length > 0
//                        && grantResults[0] == PackageManager.PERMISSION_GRANTED;
//                break;
//            case 2:
//                // If request is cancelled, the result arrays are empty.
//                BoomtownAPI.sharedInstance().isCameraPermitted = grantResults.length > 0
//                        && grantResults[0] == PackageManager.PERMISSION_GRANTED;
//                break;
//            default:
//                Log.w(TAG, "unknown permissions request code received: " + requestCode);
//                break;
//        }
//    }
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                if (getString(R.string.label_take_photo).equals(items[item])) {
                    if (ContextCompat.checkSelfPermission(BTConnectHelpBaseActivity.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_GRANTED) {
                        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                        startActivityForResult(intent, REQUEST_CAMERA);
                    } else {
                        Toast.makeText(BTConnectHelpBaseActivity.this, "You do not have permission to use the camera.", Toast.LENGTH_LONG).show();
                    }
                } else if (getString(R.string.label_choose_from_library).equals(items[item])) {
                    if (ContextCompat.checkSelfPermission(BTConnectHelpBaseActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                            == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(BTConnectHelpBaseActivity.this, "You do not have permission to use the gallery.", Toast.LENGTH_LONG).show();
                    }
