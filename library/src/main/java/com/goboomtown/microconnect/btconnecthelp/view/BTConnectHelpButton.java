package com.goboomtown.microconnect.btconnecthelp.view;
...
import com.goboomtown.microconnect.dnssd.BTConnectPresenceService;
...
public class BTConnectHelpButton extends View {
        ...
        if (memberID == null || memberUserID == null || memberLocationID == null) {
            if (mListener != null) {
                mListener.helpButtonDidFailWithError(
                        ...
                        mContext.getString(R.string.reason_member_info_missing)
                );
            }
        }
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.BTConnectHelpButton_exampleDrawable)) {
            ...
            mExampleDrawable = getResources().getDrawable(R.drawable.help_slider_gear_light);
            mExampleDrawable.setCallback(this);
        }
    ...
    private void getProvider() {
        ...
        BTConnectAPI.get(getContext(), uri, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                if (mListener != null)
                    mListener.helpButtonDidFailWithError(mContext.getString(R.string.error_unable_to_get_provider_info), e.getLocalizedMessage());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (success) {
                    ...
                    if (mListener != null)
                        mListener.helpButtonDidFailWithError(mContext.getString(R.string.error_unable_to_get_provider_info), message);
                }
            }
        });
    }
